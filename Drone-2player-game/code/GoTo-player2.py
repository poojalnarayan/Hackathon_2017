...
vehicle = connect("0.0.0.0:14571", wait_ready=True)
...
while(True):
	...
	print(0 , " :" ,  joysticks[1].get_button(0))
	x = 0
	y = 0
	if joysticks[1].get_button(0):
		x+=50
	if joysticks[1].get_button(2):	#straight
		x+=10
	if joysticks[1].get_button(3):  #left
		y-=10
	if joysticks[1].get_button(1):  #right
		y+=10
